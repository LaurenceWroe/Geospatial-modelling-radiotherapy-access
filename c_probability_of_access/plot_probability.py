#!/usr/bin/env python3
"""
Generate probability of access plot for any country with a specified lambda value.
"""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Generate probability of access plot for any country.")
    ...
    parser.add_argument("--output_name", default=None, help="Output PNG filename (default: <country>_accessibility_probability_<lambda>km.png)")
    ...
    if args.output_name:
        ...
        output_path = output_dir / f"{args.country.lower()}_accessibility_probability_{int(args.lambda_km)}km.png"

    print(f"Generating probability plot for {args.country} with λ={args.lambda_km} km...")
